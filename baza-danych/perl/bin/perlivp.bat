...
#!perl
#line 29
    eval 'exec C:\Users\pc\Desktop\project\project\baza-danych\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\pc\Desktop\project\project\baza-danych\perl\bin\perl.exe';
