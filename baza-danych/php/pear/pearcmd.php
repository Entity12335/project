...
if ('C:\Users\pc\Desktop\project\project\baza-danych\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\pc\Desktop\project\project\baza-danych\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
